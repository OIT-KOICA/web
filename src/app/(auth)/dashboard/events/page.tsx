import EventList from "@/components/auth/events/event-list";
import {
  Breadcrumb,
  BreadcrumbItem,
  BreadcrumbLink,
    ...
    <SidebarInset>
        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>Créer/Modifier un événement</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="flex min-h-screen justify-center py-4">
        <div className="w-full px-6">
          <h1 className="text-3xl font-bold">Liste des évènements</h1>
